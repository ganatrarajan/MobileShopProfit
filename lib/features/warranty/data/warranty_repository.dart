...
class WarrantyRepository {
  ...
  Future<ApiResponse<List<Warranty>>> getWarranties({
    ...
    try {
      ...
      return ApiResponse<List<Warranty>>(success: false, message: msg);
    }
  }
  ...
  Future<ApiResponse<Warranty>> createWarranty({
    ...
    try {
      ...
      final msg = e is ApiException ? e.message : e.toString();
      return ApiResponse<Warranty>(success: false, message: msg);
    }
  }
  ...
  Future<ApiResponse<dynamic>> deleteWarranty(int id) async {
    try {
      final response = await _apiClient.delete('${ApiEndpoints.warranties}/$id');
      if (response.success) return response;
      return await _apiClient.post('${ApiEndpoints.warranties}/$id/delete');
    } catch (_) {
      try {
        return await _apiClient.post('${ApiEndpoints.warranties}/$id/delete');
      } catch (e) {
  ...
  Future<ApiResponse<List<WarrantyClaim>>> getClaims({
    ...
    try {
      ...
      final msg = e is ApiException ? e.message : e.toString();
      return ApiResponse<List<WarrantyClaim>>(success: false, message: msg);
    }
  }
  ...
  Future<ApiResponse<WarrantyClaim>> createClaim({
    ...
    try {
      ...
      final msg = e is ApiException ? e.message : e.toString();
      return ApiResponse<WarrantyClaim>(success: false, message: msg);
    }
  }
  ...
  Future<ApiResponse<dynamic>> deleteClaim(int claimId) async {
    try {
      final response = await _apiClient.delete('${ApiEndpoints.warrantyClaims}/$claimId');
      return response;
    } catch (_) {
